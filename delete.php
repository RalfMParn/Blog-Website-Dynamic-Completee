...
if(isset($_GET['ids']) and is_numeric($_GET['ids'])) {
    $sql = 'DELETE FROM blog_posts WHERE id = '.$_GET['ids'];
    if($dbname->dbQuery($sql)) {
        $success = true;
        ...
        <div class="col-sm-8">
            ...
            if(isset($success) and $success) {
                ...
                <div class="alert alert-success">
                    Kustutamise sissekanne tabelist toimus.
                </div>
                <?php
            } else if(isset($success) and !$success) {
                ?>
                <div class="alert alert-danger">
                Kustutamise sissekanne tabelist ei toimund, tekkis tõrge.
                </div>
                <?php
            }
